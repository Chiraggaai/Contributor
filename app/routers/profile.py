...
from app.deps import get_contributor_id
from app.schemas.digital_twin import DigitalTwinHistoryResponse, DigitalTwinResponse, PeriodQuery
from app.schemas.evidence import EvidenceCreate, EvidenceListResponse, EvidenceResponse, EvidenceUpdate
from app.schemas.profile import ProfilePatchBody, ProfileResponse, SkillsPutBody
from app.services.profile_store import store

router = APIRouter(prefix="/api/contributor/profile", tags=["Contributor Profile"])
