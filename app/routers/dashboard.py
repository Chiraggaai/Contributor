...
from app.services import dashboard_store as dash

router = APIRouter(prefix="/api/contributor", tags=["contributor-dashboard"])


@router.get("/me", response_model=ContributorMe)
def get_me() -> ContributorMe:
    return dash.get_contributor_me()
